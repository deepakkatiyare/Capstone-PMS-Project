...
export class PendingListComponent implements OnInit {
  ...
  constructor(private matdialog: MatDialog, private service: AppointmentService, private patient: PatientBasicInfoService, private RegisterService: PatientRegisterService) {
